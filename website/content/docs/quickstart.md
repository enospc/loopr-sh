...
<section class="doc-body">
  ...
  <p>This creates <code>AGENTS.md</code> (or injects a Loopr section) and writes <code>loopr/state/docs-index.txt</code>. Use <code>loopr init --no-agents</code> to skip AGENTS changes.</p>
